...
COMMENT ON TABLE public.psf_meta is 'Scanner File parsed data';

SELECT psf.add_constraint('psf_meta','psf_meta_psf_files_fk','FOREIGN KEY (p_id) REFERENCES public.psf_files','public');
